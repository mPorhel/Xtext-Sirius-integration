...
public class XtextEmbeddedEditor {
    ...
    private XtextResource createVirtualXtextResource(URI uri, EObject semanticElement) throws IOException {
        ...
        XtextResource xtextVirtualResource = (XtextResource) resourceFactory.createResource(URI.createURI(uri.toString()));
    ...
    private void reconcile(Resource resourceInSirius, XtextResource resourceInEmbeddedEditor) {
        try {
            ...
            editingDomain.getCommandStack().execute(new RecordingCommand(editingDomain, "update resource after direct text edit") {
